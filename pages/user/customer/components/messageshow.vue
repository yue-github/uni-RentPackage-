<template>
	<view class="m-item" :id="'message'+id1">
		<view class="m-left">
			<!-- <image class="head_icon" :src="abosultPaht+user.home.img" v-if="message.user=='home'"></image> -->
		<image class="head_icon" src="../../../../static/img/homeHL.png" v-if="message.user=='home'"></image>
		</view>
		...
		<view class="m-right">
		<image class="head_icon" src="../../../../static/img/customerHL.png" v-if="message.user=='customer'"></image>
...
<style>
	...
	.m-content-head-customer:after {
		border: 15upx solid transparent;
		border-left: 15upx solid #4CD964;
		top: 20upx;
		right: -26upx;
		width: 0;
		height: 0;
